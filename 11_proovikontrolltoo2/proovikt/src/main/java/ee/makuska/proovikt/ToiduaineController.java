...
public class ToiduaineController {
    ...
    private final ToidukomponentRepository toidukomponentRepository;

    public ToiduaineController(ToiduaineRepository toiduaineRepository, ToidukomponentRepository toidukomponentRepository) {
